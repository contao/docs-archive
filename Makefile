...
validate: build install-python
	...
	@python_modules/bin/python2.7 python_modules/bin/html5validator --root cookbook/_book/          --ignore "gitbook/plugins" "element must have an" "A document must not include both"
	@python_modules/bin/python2.7 python_modules/bin/html5validator --root api/_book/               --ignore "gitbook/plugins" "element must have an" "A document must not include both"
	@python_modules/bin/python2.7 python_modules/bin/html5validator --root contao4-migration/_book/ --ignore "gitbook/plugins" "element must have an" "A document must not include both"
