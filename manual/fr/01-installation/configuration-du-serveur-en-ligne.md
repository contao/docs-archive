...
> **Note** En fonction de vos extensions installées, il peut être nécessaire d'augmenter la valeur de la variable PHP max_input_vars (par ex. 2000 ou supérieur). Sinon, les longs formulaires du back office ne peuvent pas être soumis entièrement.
