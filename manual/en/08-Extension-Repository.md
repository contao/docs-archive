...
The files can also be imported from a GitHub repository. It is required that the release is tagged and that the tag has been pushed to the central GitHub repository.

In the extension settings, you have to enter the HTTPS URL of the GitHub repository.
